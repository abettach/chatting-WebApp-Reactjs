...
const MessageZone = () => {
    return (
        <div className="d-flex align-items-center justify-content-center shadow-sm position-relative" style={{background:'white',width: '99.9%', height: '110px'}}>
            <div className='d-flex align-items-center w-100 h-100 position-absolute'>
                ...
                <img src={line} alt="" className='position-absolute' style={{right: '93%', height: '40%'}} />
            ...
            <form action="" className='group-text w-100 h-100 d-flex align-items-center justify-content-center'>
                ...
                <input type="text" name="" placeholder='Your messages...' id="chatInput" className='form-control rounded-4 border border-0 bg-light' style={{width: '95%', height: '80px', textIndent: '5%'}}/>
            </form>
        </div>
    )
}
