    ...
    return (
        <div className='container d-flex flex-column align-items-center h-auto'>
            <div className='position-relative rounded-circle mt-5 mb-3 bg-danger' style={{width: '200px', height: "200px", marginTop: '80px'}}>
                <img src={img} alt="" className='rounded-circle w-100 h-100'/>
            ...
            <p className='mb-4 fs-2' style={{ fontWeight: '500'}}><span className='text-capitalize'>elizabeth</span><span className='text-capitalize'> charlotte</span></p>
