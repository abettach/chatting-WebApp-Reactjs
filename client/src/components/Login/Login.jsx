...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        .then((data) => {
            // if (data.data) navigation('/', {replace: true})
            console.log(data.data)
        });
    }
    return(
        <div className="position-absolute bg-light h-100 w-100 d-flex justify-content-start">
            <img src={login_background} alt="img" className="rounded-5 m-2"/>
            <div className="container-sm d-flex justify-content-center align-items-center position-relative">
                ...
                <form className="d-flex flex-column justify-content-center align-items-start position-relative gap-5 w-50" onSubmit={handleSubmit}>
