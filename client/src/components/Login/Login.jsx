...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('/api/login',data).then((data) => {
            if (data.data === 'Successfully Authenticated') window.location.href = "http://localhost:3000/";
                ...
                <div className="position-absolute bg-light h-100 w-100 d-flex justify-content-start">
                    ...
                    <div className="container-sm d-flex flex-column justify-content-center align-items-center position-relative overflow-hidden" style={{maxHeight: '100%'}}>
                        ...
                        <form className="form-group d-flex flex-column justify-content-center align-items-center position-relative gap-5 w-100" onSubmit={handleSubmit}>
                            ...
                            <p className={`text-danger ${user === null ? 'd-none' : ''}`}>username or password incorrect !</p>
