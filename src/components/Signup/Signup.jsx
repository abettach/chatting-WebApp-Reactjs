        ...
        <div className="position-absolute bg-light h-100 w-100 d-flex justify-content-start">
            ...
            <div className="container-sm d-flex justify-content-center align-items-center position-relative">
                <div className=" position-absolute d-flex flex-column align-items-start gap-4" style={{top: "20%", right: '41%', color: "#3A3F5D"}}>
                    ...
                    <span className="fw-semi-bold fs-4 text-capitalize">already have an account? <span style={{color: '#3E83D4'}}>Log In</span></span>
                </div>
                <form action="" className="d-flex flex-column justify-content-center align-items-center position-relative gap-5">
                    <div className="position-relative  flex-nowrap">
                        ...
                        <input type="text" className="rounded-4 border border-0 me-4 shadow-sm pt-3 " style={{width: '270px',height: '100px', background: '#FFFFFF', textIndent: '10%'}}/>
                        <label className="position-absolute ms-4 mt-3 text-black-50 " htmlFor="LastName">Last name</label>
                        <input className="rounded-4 border border-0 shadow-sm pt-3 " type="text" style={{width: '270px',height: '100px', background: '#FFFFFF', textIndent: '10%'}}/>
                    </div>
                    <label htmlFor="email" className="position-absolute text-black-50" style={{bottom: "63%", left: '5%'}}>Email</label>
                    <input className="rounded-4 border border-0 shadow-sm pt-4 w-100" type="email" style={{width: '554px',height: '100px', background: '#FFFFFF', textIndent: '4.5%'}}/>
                    <label htmlFor="Password"  className="position-absolute text-black-50" style={{bottom: "35%", left: '5%'}} >Password</label>
                    <input className="rounded-4 border border-0 shadow-sm pt-4 w-100" type="password" style={{width: '554px',height: '100px', background: '#FFFFFF', textIndent: '4.5%'}}/>
